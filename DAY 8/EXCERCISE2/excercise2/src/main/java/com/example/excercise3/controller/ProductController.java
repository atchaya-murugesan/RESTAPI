...
import com.example.excercise3.service.ProductService;
...
public class ProductController {
    ...
    @GetMapping("/product/distinct/startwith/{productName}")
    public ResponseEntity<List<Product>> getAll(@PathVariable("productName") String name) {
    ...
    @GetMapping("product/distict/endswith/{productName}")
    public ResponseEntity<List<Product>> getbyAge(@PathVariable("productName") String name) {
